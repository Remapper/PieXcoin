...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"piex", "listmasternodes", &listmasternodes, true, true, false},
        {"piex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"piex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"piex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"piex", "masternodedebug", &masternodedebug, true, true, false},
        {"piex", "startmasternode", &startmasternode, true, true, false},
        {"piex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"piex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"piex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"piex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"piex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"piex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"piex", "mnbudget", &mnbudget, true, true, false},
        {"piex", "preparebudget", &preparebudget, true, true, false},
        {"piex", "submitbudget", &submitbudget, true, true, false},
        {"piex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"piex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"piex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"piex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"piex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"piex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"piex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"piex", "checkbudgets", &checkbudgets, true, true, false},
        {"piex", "mnsync", &mnsync, true, true, false},
        {"piex", "spork", &spork, true, true, false},
        {"piex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
